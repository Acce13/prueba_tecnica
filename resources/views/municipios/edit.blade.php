@extends('layouts.app')
@section('title', 'Municipios - Editar')
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('municipios.update', $municipio) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="inputDepartamento" name="departamento_id" required>
                                    ...
                                    @foreach($departamentos as $departamento)
                                        <option value="{{ $departamento->id }}" {{ ($municipio->departamento_id == $departamento->id) ? 'selected' : '' }}>{{ $departamento->departamento }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inputMunicipio" name="municipio" value="{{ old('municipio', $municipio->municipio) }}" placeholder="Municipio" required>
                            </div>
